...
.cup { position: absolute; transform: translate(-50%, -50%); width: 16%; aspect-ratio: 1; border-radius: 9999px; display: grid; place-items: center; border: 2px solid transparent; background: transparent; cursor: default; padding: 0; }
